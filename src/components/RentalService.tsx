    ...
    <section id="chintai" className="bg-[#f8f7f4] py-16 md:py-24 scroll-mt-16">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <p className="text-lg font-light text-[#6B7280] text-center mb-8 max-w-3xl mx-auto">
          条件だけでなく、将来の選択肢まで含めて整理します。<br />
          無理のない家賃設計と物件選定で、納得できる部屋探しを実現します。
        </p>
      ...
      <div className="relative w-full h-[200px] md:h-[300px] mt-10">
        <Image
          src="https://res.cloudinary.com/dh2xvp5xj/image/upload/v1777606131/ChatGPT_Image_2026%E5%B9%B45%E6%9C%881%E6%97%A5_12_28_28_dsjz0e.png"
          alt="賃貸"
          fill
